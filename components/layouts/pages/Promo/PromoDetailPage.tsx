...
import { PromoRecomendations } from "./PromoRecomendations";
import { normalizeCategory, Promo } from "@/lib/types/promo";
import { formatPrice } from "@/lib/utils/formatPrice";
import { promoCategories } from "@/lib/types/promo"; // Add this import
...
const PromoDetailPage = () => {
  ...
  const getTimeRange = (category: string) => {
    const normalizedCategory = normalizeCategory(category);
    return promoCategories[normalizedCategory]?.timeRange || "All day";
  };
        ...
        >
          ...
          <div className="p-4 sm:p-6 md:p-8 w-full lg:w-1/2 xl:w-[40%]">
            ...
            <div className="mt-6">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                {getTimeRange(currentPromo.category)}
              </p>
            </div>
