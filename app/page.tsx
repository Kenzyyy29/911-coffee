...
const menu = [
 {name: "Butter Coffee", image: "/menus/8.png", price: "Rp. 32,340"},
 {name: "Tahu Lada Garam", image: "/menus/4.png", price: "Rp. 19,635"},
 {name: "Korova Mushroom", image: "/menus/27.png", price: "Rp. 78,540"},
];
...
const instagramPosts = [
 {
  id: 1,
  url: "https://www.instagram.com/p/DC3imuWpKWs/",
  imageUrl: "https://www.instagram.com/p/DC3imuWpKWs/media/?size=l",
 },
 {
  id: 2,
  url: "https://www.instagram.com/p/CxamplePost2/",
  imageUrl: "https://scontent.cdninstagram.com/v/your-image2.jpg",
 },
 {
  id: 3,
  url: "https://www.instagram.com/p/CxamplePost3/",
  imageUrl: "https://scontent.cdninstagram.com/v/your-image3.jpg",
 },
 {
  id: 4,
  url: "https://www.instagram.com/p/CxamplePost4/",
  imageUrl: "https://scontent.cdninstagram.com/v/your-image4.jpg",
 },
];
    ...
    <div className="container mx-auto px-6">
     <motion.div
      ...
      <motion.div
       ...
       <h1 className="text-4xl font-bold mb-10">{kelebihan.name}</h1>
   ...
   <section className="py-20 bg-[#f4f4f4]">
    <div className="container mx-auto px-6">
      ...
      {menu.map((item, index) => (
       <motion.div
        ...
        <div className="p-6 flex flex-col items-center">
         <div className="w-40 h-40 rounded-full bg-gray-100 flex items-center justify-center mb-6 overflow-hidden">
          <img
           src={item.image}
           alt={item.name}
         ...
         <button className="text-black font-medium flex items-center gap-1 hover:text-gray-700 transition-colors">
          Add to order <BsArrowRight />
         </button>
        </div>
       </motion.div>
      ))}
     ...
     <motion.div
      ...
      <Link
       href="/product"
       className="inline-flex items-center px-6 py-3 border border-black rounded-full font-medium hover:bg-black hover:text-white transition-colors">
    ...
    <div className="container mx-auto px-6">
     <motion.div
      ...
      <motion.div
       ...
       className="lg:w-1/2">
       <div className="bg-black rounded-xl h-[500px] w-full overflow-hidden shadow-2xl">
        <img
         src="/6.jpeg"
         alt="Coffee Shop"
         className="w-full h-full object-cover"
      ...
      <motion.div
       ...
       <div className="space-y-4">
        <div className="flex items-center gap-4">
         ...
         <p className="text-gray-600">Buka setiap hari: 08:00 - 22:00</p>
        </div>
        <div className="flex items-center gap-4">
         <TbMapPin className="text-2xl" />
         <p className="text-gray-600">Jl. Contoh No. 123, Tasikmalaya</p>
        </div>
       </div>
      </motion.div>
     </motion.div>
   ...
   <section className="py-20 bg-white">
    <div className="container mx-auto px-6">
     <motion.div
      ...
      <p className="text-gray-600">@911coffee.tasikmalaya</p>
     </motion.div>
     ...
     <motion.div
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-4">
       ...
       <motion.div
        ...
        <Link
         href="/product"
         className="border border-black px-8 py-4 rounded-full font-medium inline-flex items-center gap-2">
         Lihat Menu
        </Link>
       </motion.div>
      </div>
